...
Update_Status ModuleController::PreUpdate()
{
	...
	if (controller_player1_Start_pressed == true && App->input->keys[SDL_SCANCODE_RETURN] == Key_State::KEY_IDLE)
	{
		App->input->keys[SDL_SCANCODE_RETURN] = Key_State::KEY_DOWN;
	}
	else if (controller_player1_Start_pressed == true)
	{
		App->input->keys[SDL_SCANCODE_RETURN] = Key_State::KEY_REPEAT;
	}


	if (controller_player1_X_pressed == true && App->input->keys[SDL_SCANCODE_ESCAPE] == Key_State::KEY_IDLE)
	{
	...
	if (controller_player1_B_pressed == true && App->input->keys[SDL_SCANCODE_LALT] == Key_State::KEY_IDLE)
	{
		App->input->keys[SDL_SCANCODE_LALT] = Key_State::KEY_DOWN;
	}
